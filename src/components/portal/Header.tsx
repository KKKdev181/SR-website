  ...
  return (
    <header className="sticky top-0 z-50 border-b border-blue-700 bg-[#0757b8] text-white shadow-sm">
      <nav
        ...
        className="mx-auto flex min-h-[76px] max-w-[1920px] items-center justify-between gap-3 px-3 sm:px-6"
      >
        <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3 lg:gap-4">
          <Link
            to="/"
            className="flex shrink-0 items-center gap-4 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            aria-label="Elm Requests Portal"
          >
            <span className="flex items-center gap-3" aria-label="Elm | علم">
              <img src="/elmlogo.png" alt="" className="h-12 w-auto brightness-0 invert sm:h-14" />
              <span className="flex min-w-[54px] flex-col items-center justify-center leading-none text-white">
                <span lang="ar" dir="rtl" className="text-[21px] font-extrabold leading-[0.9] sm:text-[24px]">
                  علم
                </span>
                <span className="mt-1 text-[18px] font-extrabold leading-[0.9] tracking-[0.04em] sm:text-[20px]">
                  elm
                </span>
              </span>
            </span>
            <span className="hidden h-11 w-px bg-white/35 sm:block" />
