...
const sectionVisuals: Record<string, SectionVisual> = {
  "General Help": {
    icon: "bg-[#e9f2ff] text-[#0c66e4]",
    tag: "bg-[#e9f2ff] text-[#0c66e4]",
  },
  "Infrastructure & Hosting": {
    icon: "bg-[#f1f2f4] text-[#44546f]",
    tag: "bg-[#f1f2f4] text-[#44546f]",
  },
  "Storage & Backup": {
    icon: "bg-[#eae6ff] text-[#5243aa]",
    tag: "bg-[#eae6ff] text-[#403294]",
  },
  "Network & Connectivity": {
    icon: "bg-[#e6fcff] text-[#00a3bf]",
    tag: "bg-[#e6fcff] text-[#006d87]",
  },
  "Access & Privileges": {
    icon: "bg-[#deebff] text-[#0052cc]",
    tag: "bg-[#deebff] text-[#0747a6]",
  },
  ...
  "Application Lifecycle": {
    icon: "bg-[#fff0b3] text-[#974f0c]",
    tag: "bg-[#fff0b3] text-[#7f5f01]",
  },
  "Application & Database": {
    icon: "bg-[#e3fcef] text-[#00875a]",
    tag: "bg-[#e3fcef] text-[#006644]",
  },
  "DevOps & Software Delivery": {
    icon: "bg-[#eae6ff] text-[#6554c0]",
    tag: "bg-[#eae6ff] text-[#403294]",
  },
  "Jira & Amer": {
    icon: "bg-[#deebff] text-[#0052cc]",
  ...
  "UX, Web & Mobile": {
    icon: "bg-[#ffebe6] text-[#de350b]",
    tag: "bg-[#ffebe6] text-[#bf2600]",
  },
  "Business Operations": {
    icon: "bg-[#fff0b3] text-[#974f0c]",
    tag: "bg-[#fff0b3] text-[#7f5f01]",
