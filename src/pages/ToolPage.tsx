        ...
        {tool === "checklist" && (
          <section className="journey-overview mb-7" aria-label={isArabic ? "مراحل رحلة المشروع" : "Project journey stages"}>
            <div className="journey-overview-heading">
              <div>
                <span className="journey-overview-kicker">{isArabic ? "مسار واضح من البداية إلى الإطلاق" : "A clear path from setup to go-live"}</span>
            ...
            <div className="journey-stage-grid">
              {journeyStages.map((stage, index) => {
                ...
                return (
                  <a key={stage.href} href={stage.href} className="journey-stage-card">
